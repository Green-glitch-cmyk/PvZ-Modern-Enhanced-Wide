...
Image* Sexy::IMAGE_SELECTORSCREEN_ACHIEVEMENT_BUTTON;
Image* Sexy::IMAGE_SELECTORSCREEN_ACHIEVEMENT_HIGHLIGHT;
...
bool Sexy::ExtractLoadingImagesResources(ResourceManager *theManager)
{
	...
	try
	{
		IMAGE_SELECTORSCREEN_ACHIEVEMENT_BUTTON = aMgr.GetImageThrow("IMAGE_ACHIEVEMENT_BUTTON");
		IMAGE_SELECTORSCREEN_ACHIEVEMENT_HIGHLIGHT = aMgr.GetImageThrow("IMAGE_ACHIEVEMENT_HIGHLIGHT");
		IMAGE_SELECTORSCREEN_QUICKPLAY_BUTTON = aMgr.GetImageThrow("IMAGE_QUICKPLAY_BUTTON");
		IMAGE_SELECTORSCREEN_QUICKPLAY_BUTTON_HIGHLIGHT = aMgr.GetImageThrow("IMAGE_QUICKPLAY_BUTTON_HIGHLIGHT");
...
const char* Sexy::GetStringIdById(int theId)
{
	switch(theId)
	{
		...
		case IMAGE_SELECTORSCREEN_ACHIEVEMENT_BUTTON_ID: return "IMAGE_ACHIEVEMENT_BUTTON";
		case IMAGE_SELECTORSCREEN_ACHIEVEMENT_HIGHLIGHT_ID: return "IMAGE_ACHIEVEMENT_HIGHLIGHT";
