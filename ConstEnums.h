...
enum SeedType
{
    ...
    ENUM_AUTO_VALUE(SEED_SLOT_MACHINE_SUN)
    ENUM_AUTO_VALUE(SEED_SLOT_MACHINE_DIAMOND)
    ENUM_AUTO_VALUE(SEED_ZOMBIQUARIUM_SNORKLE)
    ENUM_AUTO_VALUE(SEED_ZOMBIQUARIUM_TROPHY)
    ENUM_AUTO_VALUE(SEED_ZOMBIE_NORMAL)
    ENUM_AUTO_VALUE(SEED_ZOMBIE_TRAFFIC_CONE)
    ENUM_AUTO_VALUE(SEED_ZOMBIE_POLEVAULTER)
    ENUM_AUTO_VALUE(SEED_ZOMBIE_PAIL)
    ENUM_AUTO_VALUE(SEED_ZOMBIE_LADDER)
    ENUM_AUTO_VALUE(SEED_ZOMBIE_DIGGER)
    ENUM_AUTO_VALUE(SEED_ZOMBIE_BUNGEE)
    ENUM_AUTO_VALUE(SEED_ZOMBIE_FOOTBALL)
    ENUM_AUTO_VALUE(SEED_ZOMBIE_BALLOON)
    ENUM_AUTO_VALUE(SEED_ZOMBIE_SCREEN_DOOR)
    ENUM_AUTO_VALUE(SEED_ZOMBONI)
    ENUM_AUTO_VALUE(SEED_ZOMBIE_POGO)
...
enum ZombieType
{
    ...
    ENUM_AUTO_VALUE(ZOMBIE_TRAFFIC_CONE)
    ENUM_AUTO_VALUE(ZOMBIE_POLEVAULTER)
    ENUM_AUTO_VALUE(ZOMBIE_PAIL)
    ENUM_AUTO_VALUE(ZOMBIE_NEWSPAPER)
    ENUM_AUTO_VALUE(ZOMBIE_DOOR)
    ENUM_AUTO_VALUE(ZOMBIE_FOOTBALL)
    ENUM_AUTO_VALUE(ZOMBIE_DANCER)
    ENUM_AUTO_VALUE(ZOMBIE_BACKUP_DANCER)
    ENUM_AUTO_VALUE(ZOMBIE_DUCKY_TUBE)
    ENUM_AUTO_VALUE(ZOMBIE_SNORKEL)
    ENUM_AUTO_VALUE(ZOMBIE_ZAMBONI)
    ENUM_AUTO_VALUE(ZOMBIE_BOBSLED)
    ENUM_AUTO_VALUE(ZOMBIE_DOLPHIN_RIDER)
    ENUM_AUTO_VALUE(ZOMBIE_JACK_IN_THE_BOX)
    ENUM_AUTO_VALUE(ZOMBIE_BALLOON)
    ENUM_AUTO_VALUE(ZOMBIE_DIGGER)
    ENUM_AUTO_VALUE(ZOMBIE_POGO)
    ENUM_AUTO_VALUE(ZOMBIE_YETI)
    ENUM_AUTO_VALUE(ZOMBIE_BUNGEE)
    ENUM_AUTO_VALUE(ZOMBIE_LADDER)
    ENUM_AUTO_VALUE(ZOMBIE_CATAPULT)
    ENUM_AUTO_VALUE(ZOMBIE_GARGANTUAR)
    ENUM_AUTO_VALUE(ZOMBIE_IMP)
    ENUM_AUTO_VALUE(ZOMBIE_BOSS)
    ENUM_AUTO_VALUE(ZOMBIE_REDEYE_GARGANTUAR)
    ENUM_AUTO_VALUE(ZOMBIE_PEA_HEAD)
    ENUM_AUTO_VALUE(ZOMBIE_WALLNUT_HEAD)
    ENUM_AUTO_VALUE(ZOMBIE_JALAPENO_HEAD)
    ENUM_AUTO_VALUE(ZOMBIE_GATLING_HEAD)
    ENUM_AUTO_VALUE(ZOMBIE_SQUASH_HEAD)
    ENUM_AUTO_VALUE(ZOMBIE_TALLNUT_HEAD)
